...
func builtinRegistrations(router *Router) []tool.ToolRegistration {
	...
	return []tool.ToolRegistration{
		...
		registration(router, source, "data", "schema", OperationDataSchema,
			...
			[]tool.Protocol{tool.ProtocolMemcached, tool.ProtocolElasticsearch, tool.ProtocolOpenSearch, tool.ProtocolMySQL, tool.ProtocolMariaDB, tool.ProtocolSQLServer, tool.ProtocolOracle, tool.ProtocolClickHouse, tool.ProtocolPostgreSQL, tool.ProtocolRedis, tool.ProtocolMongoDB}, []tool.Capability{"data.schema"}, tool.RiskReadOnly, tool.ApprovalNever,
